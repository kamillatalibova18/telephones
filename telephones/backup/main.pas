...
type
  ...
  TfMain = class(TForm)
    ...
    procedure bAdd3Click(Sender: TObject);
    procedure bAdd4Click(Sender: TObject);
...
procedure TfMain.bAdd2Click(Sender: TObject);
begin
...
procedure TfMain.bAdd3Click(Sender: TObject);
begin
...
procedure TfMain.bAdd4Click(Sender: TObject);
begin
  //если данных в сетке нет - просто выходим:
  if SG.RowCount = 1 then exit;
